...
PROXY_METHOD1(void, SetVolume, double)
PROXY_CONSTMETHOD0(double, GetVolume)
PROXY_METHOD1(AudioProcessingOptionsResult, SetAudioProcessingOptionsWithResult, const AudioOptions &)
PROXY_METHOD1(bool, SetAudioProcessingOptions, const AudioOptions&)
