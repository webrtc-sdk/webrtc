...
static_assert(std::is_standard_layout<CodecSpecificInfoVP8>::value, "");
...
static_assert(std::is_standard_layout<CodecSpecificInfoVP9>::value, "");
...
static_assert(std::is_standard_layout<CodecSpecificInfoH264>::value, "");
...
static_assert(std::is_standard_layout<CodecSpecificInfoUnion>::value, "");
