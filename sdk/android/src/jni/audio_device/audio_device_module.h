...
class AudioInput {
 public:
  ...
  virtual std::optional<bool> BuiltInAECIsDesired() const {
    return std::nullopt;
  }
  virtual std::optional<bool> BuiltInAECIsEnabled() const {
    return std::nullopt;
  }
  virtual std::optional<bool> BuiltInNSIsDesired() const {
    return std::nullopt;
  }
  virtual std::optional<bool> BuiltInNSIsEnabled() const {
    return std::nullopt;
  }
};
